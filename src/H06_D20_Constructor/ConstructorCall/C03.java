...
public class C03 {
    ...
    C03(int sayi , String ism){
        this(); //parametresiz constructer'a git / this() constructer'in ilk satirinda olmak zorundadir!!!!!!! Parantezli olmayanda boyle bir zorunluluk yok
        this.sayi = 34; //class leveldeki objeye ait sayi variable degeri 34 olsun demis
    ...
    public static void main(String[] args) {
        ...
        C03 obj1 = new C03(); //parametresiz constructer'a goturur
