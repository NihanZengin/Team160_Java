...
public class OgrenciMapClass {
    ...
    //numara , isim , soyisim lerini liste olarak yazdirin
    ...
    //ogrenci no , sinif , sube , isim yazdirin

    public static void soyisimdenOgrenciBilgiYAzdirma (String arananSoyisim){
