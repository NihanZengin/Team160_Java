...
public class C03_Corsa extends C02_Opel{
    ...
    C03_Corsa(){
        ...
        //super(); //aslinda ilk satirda( biz olusturmadigimizda ) Java gorunmez bir super(); ConstructorCall olusturur.
        //Ki boylece olusturdugumuz obje Parent class'taki constructor'lara da ulasabilsin.
