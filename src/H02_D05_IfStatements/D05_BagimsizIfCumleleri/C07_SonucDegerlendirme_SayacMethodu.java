...
public class C07_SonucDegerlendirme_SayacMethodu {
    public static void main(String[] args) {
        ...
        // 5- hic bir sarti saglamiyorsa "sayilar uygun degil" yazdirin
        // eger sayilar tum sartlari saglarsa "sayilar mukemmel" yazdirin

        //2.YONTEM: en basta bir sayac olustururuz. sartlari tek tek sayar.
        // sayac 4 ise sayilar mukemmel, sayac 0 ise sayilar uygun degil
