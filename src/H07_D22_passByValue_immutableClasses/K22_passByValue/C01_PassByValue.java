...
public class C01_PassByValue {
    ...
    public static void main(String[] args) {
        ...
        ismiDuzenleYazdir(isim); //--> Burada variable'in degeri methoda gonderildi.
    ...
    public static void ismiDuzenleYazdir(String str){
        // System.out.println(isim); isim variable'ini kullanamiyorum cunku lokal bir variable'dir

        System.out.println("method basinda str : "+ str); // ali mert yilmaz can
        //str icin zaten  bir parametre olusturdugumuz icin kullanabiliyoruz
